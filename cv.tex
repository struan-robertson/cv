...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  ...
  \href{https://sr.ht/~struan/}{\uline{SourceHut}} & % row = 2, col = 1
...
% TODO need to change, two bold texts and say 'strong' too many times
\small{
...
\section{Education}
  \resumeHeadingListStart{}
    ...
    % TODO create custom tri heading for high school as got multiple qualifications
    % Or potentially just dont add the high school results as I dont think they reflect on me that well
    \resumeQuadHeading{Mallaig High School}{Mallaig, Highlands, Scotland}
    {}{Aug. 2013 -- Jun. 2019}
      \resumeItemListStart{}
...
\section{Experience}
\resumeHeadingListStart{}
  \resumeQuadHeading{Frontend Developer}{Mar. 2021 -- Present}
  {532 Design}{Dundee, Scotland}
    \resumeItemListStart{}
      \resumeItem{Working part time as a Unity developer on an upcoming multiplayer mobile sports game}
    \resumeItemListEnd{}

  \resumeQuadHeading{Client Advisor}{Aug. 2021 -- Nov 2021}
  {Hutchinson 3G}{Dundee, Scotland}
    \resumeItemListStart{}
      \resumeItem{Product expert}
      \resumeItem{Advised clients on technical issues}
    \resumeItemListEnd{}

  \resumeQuadHeading{Intern}{Mar. 2018 -- Jun. 2019}
  {SiteKit}{Isle of Skye, Scotland}
    \resumeItemListStart{}
      \resumeItem{Worked on website for charity Lucky2BHere}
    \resumeItemListEnd{}
...
\section{Referees}
  \resumeHeadingListStart{}
    ...
    {Dissertation Advisor}{School of Computing, Dundee}
