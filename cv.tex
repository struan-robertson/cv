...
\section{Experience}
\resumeHeadingListStart{}
  \resumeQuadHeading{Frontend Developer}{Jun. 2022 -- Jan. 2023}
...
\section{Projects}
  \resumeHeadingListStart{}
    \resumeTrioHeading{Dissertation}{Python, PyTorch, Torchvision, GDAL, Numpy}{\href{https://github.com/struan-robertson/DEM-Void-Infilling}{\uline{Source Code}}}
      ...
      \resumeTrioHeading{Scala Lettercount}{Scala, Concurrent Systems, Map Reduce, Akka Actors}{\href{https://github.com/struan-robertson/Scala-Concurrent-Lettercount}{\uline{Source Code}}}
      \resumeItemListStart{}
        \resumeItem{Count a-z characters in a text file \textbf{concurrently}}
        \resumeItem{File chunked to \textbf{Akka actors} executing in parallel on each core, with work distributed by a \textbf{balancing pool}}
        \resumeItem{Uses the \textbf{map reduce} model to allow for \textbf{efficient multithreading}}
        \resumeItem{Processed over \textbf{five billion characters in ninety seconds} on a Ryzen 5950x}
      \resumeItemListEnd{}
